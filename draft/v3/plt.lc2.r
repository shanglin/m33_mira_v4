...
for (icad in 1:3) {
    ...
    ymid = 0.5*(ymax + ymin)
    ymax = 1.05 * (ymax - ymid) + ymid
    ymin = 1.05 * (ymin - ymid) + ymid
    ymin = 1.1 * (ymin - ymax) + ymax
    ylim = c(ymax, ymin)
